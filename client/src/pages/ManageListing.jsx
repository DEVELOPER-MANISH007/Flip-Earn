    ...
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handlesubmit}>
          ...
          {/* ------------------------IMAGES----------------------- */}
          <div className="mt-8">
            <Section title="Scrreen shots & Proof">
          ...
          <div className="flex justify-end mt-5 text-sm ">
            <button onClick={()=>navigate(-1)} className="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors" type="button">Cancel</button>
            <button className="px-6 py-2 border bg-indigo-600 rounded-lg text-white hover:bg-indigo-700 transition-colors" type="submit">
...
const SelectField = ({ label, options, value, onChange, required = false }) => (
  <div>
    ...
    <select
      required={required}
      className="w-full px-3 py-1.5 text-gray-600 border rounded-md focus:outline-none focus:ring-indigo-500 border-gray-300 "
      value={value}
      onChange={(e) => onChange(e.target.value)}
    >
...
// --------------------------------------------------------------------------------------------------------------
// ---------------------------------------------------------------resulabe elements for check box
...
const TextareaField = ({ label, value, onChange, required = false }) => (
  <div>
    ...
    <textarea
      ...
      value={value}
      onChange={(e) => onChange(e.target.value)}
      className="w-full px-3 text-gray-600 border rounded-md focus:outline-none focus:ring-indigo-500 border-gray-300 "
      required={required}
    />
  </div>
);
